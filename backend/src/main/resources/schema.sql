...
CREATE TABLE IF NOT EXISTS resumes (
    ...
    INDEX idx_resumes_applied_role (applied_role)
);
...
CREATE TABLE IF NOT EXISTS screening_reports (
    ...
    INDEX idx_screening_score (score),
...
CREATE TABLE IF NOT EXISTS shortlisted_candidates (
    ...
    UNIQUE KEY uk_shortlist_resume_role (resume_id, role_name)
);
...
CREATE TABLE IF NOT EXISTS live_interviews (
    ...
    UNIQUE KEY uk_live_interview_host_token (host_token),
    UNIQUE KEY uk_live_interview_candidate_token (candidate_token)
);
...
CREATE TABLE IF NOT EXISTS hiring_decisions (
    ...
    UNIQUE KEY uk_hiring_report (report_id)
);
